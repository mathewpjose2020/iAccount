    ...
    public class DatabaseInitializer : IDatabaseInitializer
    {
        ...
        public async Task SeedAsync()
        {
            ...
            if (!await _context.Customers.AnyAsync() && !await _context.ProductCategories.AnyAsync())
            {
                ...
                AccountType accounttype_1 = new AccountType
                {
                    AccountTypeName = "SB",
                ...
                BankAccount account_1 = new BankAccount
                {
                    ...
                    Address = "pathiparampil",
                    Country="india",
                    State = "kerala",
                    ContactNo = "9082353297",
                    ContactEmail = "mathewpjose2020@hotmail.com",
                ...
                _context.AccountTypes.Add(accounttype_1);
                _context.AccountTypes.Add(accounttype_2);
