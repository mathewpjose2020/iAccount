...
namespace DAL
{
    public class ApplicationDbContext : IdentityDbContext<ApplicationUser, ApplicationRole, string>
    {
        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            builder.Entity<AccountType>().Property(c => c.AccountTypeName).IsRequired();
            builder.Entity<AccountType>().Property(c => c.AccountTypeShortName).IsRequired();
            builder.Entity<AccountType>().HasIndex(c => c.AccountTypeName).IsUnique();
