...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DAL.Models.AccountType", b =>
            {
                ...
                b.Property<string>("AccountTypeShortName")
                   .IsConcurrencyToken()
                   .HasColumnType("nvarchar(max)");
                ...
                b.HasIndex("AccountTypeName")
                    .IsUnique()
                    .HasName("AccountTypeNameIndex")
                    .HasFilter("[AccountTypeName] IS NOT NULL");

                b.ToTable("AppAccountTypes");
            });
            ...
            modelBuilder.Entity("DAL.Models.BankAccount", b =>
            {
                ...
                b.HasIndex("AccountNo")
                    .IsUnique()
                    .HasName("AccountNoIndex")
                    .HasFilter("[AccountNo] IS NOT NULL");

                b.ToTable("AppBankAccounts");
            });
